...
- Pending — High-`N` dedicated stress test run (k6/autocannon) with a results table —
...
thing. See the root README's Testing section for what each suite covers in detail.
